...
def menu():
    ...
    if choice == '1':
        print('To Encrypt a file enter Password, Salt and file-location. Type "menu" for different option or "quit" to exit.')
        encfile()
    elif choice == '2':
        print('To Decrypt a file enter Password, Salt and file-location. Type "menu" for different option or "quit" to exit.')
        decfile()
    elif choice == '3':
        print('To Encrypt a folder enter Password, Salt and folder-location. Type "menu" for different option or "quit" to exit.')
        encfolder()
    elif choice == '4':
        print('To Decrypt a folder enter Password, Salt and folder-location. Type "menu" for different option or "quit" to exit.')
        decfolder()
    elif choice == 'quit':
        print('\nProgram Ended.')
    else:
        print('\nInserisci solo le sclete mostrate')
        menu()
...
def encfile():
    ...
    if upassword == 'quit':
        ...
        if usalt == 'quit':
            ...
            def enc():
                fileln = input('Enter file locations(separati da virgola) - ').split(',')
...
def decfile():
    ...
    if upassword == 'quit':
        ...
        usalt = stdiomask.getpass(prompt='Enter Salt(separati da virgola) - ', mask='*')
